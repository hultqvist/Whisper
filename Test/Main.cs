...
namespace Test
{
	class MainClass
	{
		public static void Main(string[] args)
		{
			...
			KeyStorage senderKeyStorage = new KeyStorage();
			KeyStorage recipientKeyStorage = new KeyStorage();
			senderKeyStorage.Add(senderKey);
			senderKeyStorage.Add(recepientKey.PublicKey);
			recipientKeyStorage.Add(senderKey.PublicKey);
			recipientKeyStorage.Add(recepientKey);
		...
		/// <summary>
		/// Remove all generated diectories from previous test
		/// </summary>
